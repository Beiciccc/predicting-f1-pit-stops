...
Current local public-output families include Flexon/Raunak plateau variants, Nina `hb5`, Masaya stacking artifacts, and the refreshed Mikhail, Simon, and Nikita outputs checked on 2026-05-12. These source files are kept local and are represented publicly only through score summaries and generation scripts.
