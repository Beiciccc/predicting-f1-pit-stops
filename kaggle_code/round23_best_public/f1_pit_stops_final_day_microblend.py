...
def main():
    ...
    sarvesh_path, sarvesh = find_source(
        lambda text: "sample_submission" not in text,
        "Sarvesh triple-boost submission",
        (0.2063, 0.2073),
        (0.3008, 0.3023),
    )
    ...
    blended_rank = 0.98 * rank_norm(dataregressor[TARGET_COL]) + 0.02 * rank_norm(sarvesh[TARGET_COL])
