#!/usr/bin/env python3
"""Submit the 2026-05-20 queue and wait for public scores."""
...
LIVE_RESULTS = ROOT / "docs" / "round12_live_results.csv"


QUEUE = [
    ("ad01_s52_raw_direct.csv", "r12_loop01_ad01_s52_raw_direct"),
    ("ad02_lr52_46_01_direct.csv", "r12_loop02_ad02_lr52_46_01_direct"),
    ("ad03_lr52_46_02_direct.csv", "r12_loop03_ad03_lr52_46_02_direct"),
    ("ad04_d52_49_05_direct.csv", "r12_loop04_ad04_d52_49_05_direct"),
    ("ad05_max52_46_02_direct.csv", "r12_loop05_ad05_max52_46_02_direct"),
    ("ad06_pow52_49_10_direct.csv", "r12_loop06_ad06_pow52_49_10_direct"),
    ("ad07_harm52_46_02_direct.csv", "r12_loop07_ad07_harm52_46_02_direct"),
    ("ad08_geo52_46_02_direct.csv", "r12_loop08_ad08_geo52_46_02_direct"),
    ("ad09_srp52_46_001_direct.csv", "r12_loop09_ad09_srp52_46_001_direct"),
    ("ad10_gate52_49_top5_direct.csv", "r12_loop10_ad10_gate52_49_top5_direct"),
]
    ...
    for attempt in range(1, 6):
        try:
            out = subprocess.check_output(
                ["kaggle", "competitions", "submissions", "-c", COMPETITION, "-v", "--page-size", "100"],
                text=True,
...
def submit_one(loop_idx: int, rel: str, description: str) -> SubmissionRow:
    ...
    if existing and (existing[0].status.endswith(".COMPLETE") or existing[0].status.endswith(".ERROR")):
        row = existing[0]
        print(f"\n=== round12 loop {loop_idx}/10 already recorded: {description} {row.status} {row.public_score or 'NA'} ===", flush=True)
        record_live(loop_idx, rel, row)
        return row

    print(f"\n=== round12 loop {loop_idx}/10: {description} ===", flush=True)
    returncode = 1
