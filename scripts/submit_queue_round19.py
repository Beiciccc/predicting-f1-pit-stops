#!/usr/bin/env python3
"""Submit the 2026-05-27 queue and wait for public scores."""
...
LIVE_RESULTS = ROOT / "docs" / "round19_live_results.csv"


QUEUE = [
    ("ak01_rank_dr23_jayhawk_stack_999_001.csv", "r19_loop01_ak01_rank_dr23_jayhawk_stack"),
    ("ak02_rank_dr23_jayhawk_stack_998_002.csv", "r19_loop02_ak02_rank_dr23_jayhawk_stack"),
    ("ak03_rank_dr23_jayhawk_stack_995_005.csv", "r19_loop03_ak03_rank_dr23_jayhawk_stack"),
    ("ak04_rank_ai04_jayhawk_stack_999_001.csv", "r19_loop04_ak04_rank_ai04_jayhawk_stack"),
    ("ak05_rank_dr23_djenk_999_001.csv", "r19_loop05_ak05_rank_dr23_djenk"),
    ("ak06_rank_dr23_djenk_995_005.csv", "r19_loop06_ak06_rank_dr23_djenk"),
    ("ak07_rank_dr23_parth_999_001.csv", "r19_loop07_ak07_rank_dr23_parth"),
    ("ak08_rank_dr23_sarvesh_9995_0005.csv", "r19_loop08_ak08_rank_dr23_sarvesh"),
    ("ak09_rank_dr23_mikhail26_999_001.csv", "r19_loop09_ak09_rank_dr23_mikhail26"),
    (
        "ak10_rank_dr23_jayhawk_djenk_parth_997_0015_001_0005.csv",
        "r19_loop10_ak10_rank_dr23_jayhawk_djenk_parth",
    ),
]
...
def submit_one(loop_idx: int, rel: str, description: str) -> SubmissionRow:
    ...
    if existing and (existing[0].status.endswith(".COMPLETE") or existing[0].status.endswith(".ERROR")):
        row = existing[0]
        print(f"\n=== round19 loop {loop_idx}/10 already recorded: {description} {row.status} {row.public_score or 'NA'} ===", flush=True)
        record_live(loop_idx, rel, row)
        return row

    print(f"\n=== round19 loop {loop_idx}/10: {description} ===", flush=True)
    returncode = 1
